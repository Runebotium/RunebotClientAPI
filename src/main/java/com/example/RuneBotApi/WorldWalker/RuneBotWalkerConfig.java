...
@ConfigGroup(RuneBotWalkerPlugin.CONFIG_GROUP)
public interface RuneBotWalkerConfig extends Config {

    @ConfigItem(
            keyName = "debugMode",
            name = "Debug Mode",
            description = "Enables debug messages & overlays for development",
            position = -100
    )
    ...
    default ItemTransportSetting playerItemTransportSetting() {
        return ItemTransportSetting.All;
    }
